...
if (isset($_POST['submit'])) {
    ...
    UPDATE `xodimlar` SET `date`=:date,`get_qarz`=:get_qarz,`give_qarz`=:give_qarz,`comment`=:comment WHERE id=$id
");
...
<body>
    ...
    <form action="xodimEdit.php?id=<?= $data['id'] ?>" method="post" autocomplete="off">
