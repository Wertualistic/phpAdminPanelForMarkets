...
<body>
    ...
    <div class="check">
        <div class="col-12 col-sm-2" id="print">
            <p>Sana: <strong><?=$data['date']?></strong></p>
            <p>Ismi: <strong><?= $data['name'] ?></strong></p>
            <p>Naqd savdo: <strong> <?= $data['cash_sale'] ?> so'm</strong></p>
            <p>Terminal savdo: <strong> <?= $data['terminal_trade'] ?> so'm</strong></p>
            <p>Jami savdo: <strong> <?= $data['terminal_trade'] + $data['cash_sale'] ?> so'm</strong></p>
            <p>Kelgan Tovar: <strong> <?= $data['total_sales'] ?> so'm</strong></p>
            <p>Chiqim: <strong> <?= $data['dealy_costs'] ?> so'm</strong></p>
