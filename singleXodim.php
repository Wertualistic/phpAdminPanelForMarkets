...
$pdoStatementxodimlar = $pdo->prepare("
    SELECT * FROM `xodimlar` WHERE menu_id=$id
");

if (!$pdoStatementxodimlar->execute()) {
                ...
                <div class="col-9">
                    <table class="table table-bordered text-center mytable">
                        ...
                        <tbody>
                            ...
                            while ($data = $pdoStatementxodimlar->fetch()) {
                                // Your existing code for displaying individual rows
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" data-popper-placement="top-end">
                                                <li><a href="xodimShow.php?id=<?= $dataaa['id'] ?>">
                                                        <button class="dropdown-item" type="button"><i
                                                                class="bi col-12 btn btn-success bi-eye-fill">show</i>
                                                        </button></a></li>
                                                <li><a href="xodimEdit.php?id=<?= $dataaa['id'] ?>"><button
                                                ...
                                                <li>
                                                    <form action="#" method="Post">
                                                        <a href="xodimDelete.php?id=<?= $dataaa['id'] ?>"
